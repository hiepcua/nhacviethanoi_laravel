...
(function ($) {
	...
	$.fn.extend({
		monthly: function(customOptions) {
			...
			primaryLanguageCode = locale.substring(0, 2).toLowerCase(); // Ex: vi || en ..vv
			...
			// How many days are in this month? Return count days of month
			...
			function defaultDayNames() {
				// if(typeof Intl === "undefined") {
				// 	return ["CN", "Hai", "Ba", "Tư", "Năm", "Sáu", "Bảy"];
				// }
